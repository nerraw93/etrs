...
use Tests\Traits\ReponseStructure;
use Illuminate\Http\UploadedFile;
use Illuminate\Foundation\Testing\TestCase as BaseTestCase;

abstract class TestCase extends BaseTestCase
{
    use CreatesApplication, ResponseHelper, Accessor, ReponseStructure;
    ...
    /**
     * API Legacy reponse code
     * @var integer
     */
    const LEGACY_RESPONSE_SUCCESS = 200;
    const LEGACY_RESPONSE_CLIENT_ERROR = 401;
     ...
     */
    public function legacy_base_api($route)
    {
        return url('/' . env('APP_API_LEGACY_PREFIX', 'app/v1') . $route);
    }
}
