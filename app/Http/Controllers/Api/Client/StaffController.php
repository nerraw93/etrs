...
class StaffController extends Controller
{
    ...
    {
        $staff = ClientStaff::with('user')->find($id);
        return success_data(compact('staff'));
    }
    ...
    {
        $clientStaff = ClientStaff::find($request->id);
        if ($clientStaff) {
            $clientStaff->delete();
        }
        else {
            $clientStaff = ClientStaff::where('staff_id', $request->id);
            $clientStaff->delete();
        }
