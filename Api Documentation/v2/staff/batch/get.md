...
```json
{
    ...
    "batches":{
        ...
        "first_page_url": "http://localhost/api/staff/batch?page=1",
        "from": 1,
        "last_page": 2,
        "last_page_url": "http://localhost/api/staff/batch?page=2",
        "next_page_url": "http://localhost/api/staff/batch?page=2",
        "path": "http://localhost/api/staff/batch",
        "per_page": 10,
        "prev_page_url": null,
        "to": 10,
        "total": 16,
